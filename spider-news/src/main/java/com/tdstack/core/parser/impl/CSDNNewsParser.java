package com.tdstack.core.parser.impl;
...
import com.tdstack.core.parser.CommonParser;
...
public class CSDNNewsParser extends CommonParser<Article> {

    private static Logger logger = Logger.getLogger(CSDNNewsParser.class);
