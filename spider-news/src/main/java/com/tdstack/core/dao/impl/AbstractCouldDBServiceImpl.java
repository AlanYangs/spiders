...
public abstract class AbstractCouldDBServiceImpl <T extends BaseBean> implements CouldDBService <T>{
    private static Logger logger = Logger.getLogger(AbstractCouldDBServiceImpl.class);
